class Zenv < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/m-mizutani/zenv/releases/download/v2.5.1/zenv-v2.5.1-darwin-arm64.tar.gz"
      sha256 "d747605541f33305d942a0824a1222351004c4a9ec94893b59178999d7db8608"
    end
    on_intel do
      url "https://github.com/m-mizutani/zenv/releases/download/v2.5.1/zenv-v2.5.1-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/m-mizutani/zenv/releases/download/v2.5.1/zenv-v2.5.1-linux-arm64.tar.gz"
      sha256 "fef2b4f5862e9b1426f91d95c5907b1cefe6e29895473c2869d22687fed16373"
    end
    on_intel do
      url "https://github.com/m-mizutani/zenv/releases/download/v2.5.1/zenv-v2.5.1-linux-amd64.tar.gz"
